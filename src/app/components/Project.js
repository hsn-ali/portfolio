...
import portolio from './../../asset/projects/iengine.png'
        ...
        <div className="flex flex-col fix-height">
            ...
            <div className="grid auto-cols-[30rem] grid-flow-col overflow-x-hidden gap-4 mx-4 slider">
                ...
                <div className="w-100 slide-track h-[575px] p-2 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl text-white" style={{background: '#2f2f2f'}}>
                    ...
                    <Link to="https://inspiresupermarket.com/#/" target="_blank"><img src={link} alt="link-icon" style={{position: 'absolute',top: '2.3%',right: '3%'}}/></Link>
                </div>
                <div className="w-100 slide-track h-[575px] p-2 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl text-white" style={{background: '#2f2f2f'}}>
                    <div className="card-itsm rounded-xl">
                ...
                <div className="w-100 slide-track h-[575px] p-2 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl text-white" style={{background: '#2f2f2f'}}>
                    <div className="card-itsm rounded-xl">
                        <img className="rounded-xl" src={security} alt="" style={{width: '470px'}}/>
                    </div>
                    <div className="p-2 h-[235px] text-center">
                        <h2 className="font-bold text-lg mb-2 ">ITSM</h2>
                        <h4 className="font-bold text-lg mb-2 ">Intelligent Telecom Site Management System</h4>
